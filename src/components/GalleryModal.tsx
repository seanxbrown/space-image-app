...
export const GalleryModal = ({creatingGallery, closeModal, submitFunction, page, galleries, photos} : {creatingGallery: boolean, closeModal: ()=> void, submitFunction: any, page: "search" | "gallery", galleries: IGallery[] | null, photos?: IPhoto[] | undefined | null}) => {
